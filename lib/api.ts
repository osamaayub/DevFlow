...
export const usersApi = {
  ...
  getByEmail: (email: string) => apiRequest<UserDto>(`/api/users/email/${email}`),
...
export const accountsApi = {
  ...
  getByProviderAccountId: (providerAccountId: string) => apiRequest<AccountDto>(`/api/accounts/provider/${providerAccountId}`),
